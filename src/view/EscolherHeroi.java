...
public class EscolherHeroi extends JFrame implements ActionListener {
    ...
    private ImageIcon imagemPaladino; 
    private ImageIcon imagemGuerreiro; 
    private ImageIcon imagemBarbaro; 
    ...
    public void mostrarJanela() {
        ...
        imagemPaladino = new ImageIcon(getClass().getResource("/view/img/paladino.png"));
        imagemGuerreiro = new ImageIcon(getClass().getResource("/view/img/paladino.png"));
        imagemBarbaro = new ImageIcon(getClass().getResource("/view/img/paladino.png"));
        ...
        // Adiona ao painel o Bem-vindo, lblNomeUsuario
